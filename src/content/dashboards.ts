import salesShot from '../../assets/shots/sales.webp';
...
export const DASHBOARDS: Dashboard[] = [
  { name: 'Sales', blurb: 'Every lead, quote and close in one pipeline view — so you can see which stage is leaking deals before the month ends.', label: 'Pipeline & conversion', color: 'var(--c4)', reads: '03 + 04', metric: '₹42.6L', delta: '+18% MoM', figure: 'bars', shot: salesShot },
